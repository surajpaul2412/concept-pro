    ...
    <section class="bg-theme">
        <div class="row m-0">
            <div class="col-md-6 py-2 media-pl-5">
                <a href="{{url('/')}}">
                    <img src="{{asset('assets/frontend/images/logo.png')}}" style="margin-top: 48px !important;">
                </a>
            ...
            <div class="col-md-6 py-4 avatar" style="background:url('{{ asset('assets/frontend/images/slider/slide1/1.png') }}');background-repeat: no-repeat;background-size: 100%;overflow: hidden;">
